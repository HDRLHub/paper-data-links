...
# Using a smaller example time range due to broad time range issue
time_range_ca_ii_k = a.Time('1990-01-01', '1990-12-31')  # Example time range within the original range
...
# Using a smaller example time range due to broad time range issue
time_range_sunspot = a.Time('1996-01-01', '1996-12-31')  # Example time range within the original range

# Define the instrument and physical observable
instrument_sunspot = a.Instrument('mdi')
physobs_sunspot = a.Physobs('sunspot area')

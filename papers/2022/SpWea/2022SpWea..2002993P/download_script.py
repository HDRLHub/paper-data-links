...
# Query for SDO/AIA
# Note: Large number of results, pagination might be an issue
...
# Note: EUVI is a detector of SECCHI, not an instrument
euvi_query = Fido.search(time_range, a.Instrument('SECCHI'), a.Detector('EUVI'), a.Source('STEREO_A'))
...
# Note: COR2 is a detector of SECCHI, not an instrument
cor2_query = Fido.search(time_range, a.Instrument('SECCHI'), a.Detector('COR2'), a.Source('STEREO_A'))
print("STEREO-A/SECCHI/COR2 Query Results:")
print(cor2_query)
# Fido.fetch(cor2_query)

# Query for PSP/FIELDS
# Note: No results, possible reasons could be data availability or incorrect parameters

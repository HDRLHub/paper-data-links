...
print(iris_query)
# Note: The query returned 52 results, which may indicate pagination.
...
print(aia_query)
# Note: The query returned 1328 results, which may indicate pagination.
# Uncomment the following line to fetch the data
...
print(hmi_query)
# Note: The query returned 306 results, which may indicate pagination.
# Uncomment the following line to fetch the data
...
print(eit_query)
# Note: The query returned 0 results. This could be due to the time range being too broad or other issues.
# Uncomment the following line to fetch the data
